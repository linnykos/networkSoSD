...
key_mat <- data.frame(method = rownames(res_mat), 
                      full_name = c("SoS-Debias", "SoS-Debias (Weighted)", 
                                    ...
                                    "SoS-Debias2", "SoS-Debias2 (Weighted)"),
                      color = sapply(c("blue", "blue", "green", "green", "orange", "orange", "lightpurple", "lightpurple", "gray", "gray"), 
                                     function(x){ color_vec[which(color_name_vec == x)]}), 
                      lty = c(1,3,1,3,1,3,1,3,1,3))
key_mat
...
methods <- c("res_ss_debias_F", "res_flat_F", "res_flat_T", "res_ss_debias2_F", "res_ss_debias2_T")
