rm(list=ls())
load("../results/simulation_rho_switching.RData")
...
png("../figures/simulation_rho_switching.png", height = 1200, width = 1500, units = "px", res = 300)
par(mar = c(5,5,5,0.5))
...
plot_func(methods, res_mat, key_mat, df_param, 
          ...
          y_seq = seq(0, 0.5, length.out = 11), legend_cex = 0.4, legend_loc = "bottomleft")
graphics.off()
