rm(list=ls())
load("../results/simulation_rho_switching2.RData")
...
key_mat <- data.frame(method = rownames(res_mat), 
                      ...
                      lty = c(1,3,1,3,1,3,1,3,1,1,1), pch = c(16,16, 15,15, 17,17, 18,18,16,16,15))
key_mat

######################

png("../figures/simulation_rho_switching2.png", height = 1200, width = 1500, units = "px", res = 300)
par(mar = c(5,5,5,0.5))
...
png("../figures/simulation_rho_weighted_switching2.png", height = 1200, width = 1500, units = "px", res = 300)
par(mar = c(5,5,5,0.5))
